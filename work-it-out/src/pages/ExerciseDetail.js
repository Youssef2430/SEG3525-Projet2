...
const ExerciseDetail = () => {
  ...
  return (
    <Box>
      ...
      <ExerciseVideos exerciseVideos={exerciceVideos} name={exerciseDetail.name}/>
      <SimilarExercises targetMuscleExercisesData={targetMuscle} equipmentMuscleExercisesData={equipmentMuscle}/>
    </Box>
  )
}
